...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mt-4 mx-4">
          ...
          <li class="breadcrumb-item active" aria-current="page">Family Segments</li>
        </ol>
    </nav>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
              <h3 class="m-4">nama</h3>
                <ul class="list-group ml-3">
                  ...
                  <li class="list-group-item active side-tab"><a>Family Segments</a></li>
          ...
          <div class="col-md-9 mt-5">
              <h2 class="m-4">Family Segments</h2>
                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            <th scope="row">Nama Ibu</th>
                            <td>{{famSeg.mothersName}}</td>
                        </tr>
                        <tr>
...
export default {
  ...
  methods : {
    refreshBorrowerDetails(){
        BorrowerDataService.viewFamilySegments(this.uuid).then(res=> {
            this.famSeg = res.data;
        });
    },
  },
  created(){
