...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mt-4 mx-4">
          ...
          <li class="breadcrumb-item active" aria-current="page">Bank Segments</li>
        </ol>
    </nav>
          ...
          <div class="col-md-3">
              <h3 class="m-4">nama</h3>
                <ul class="list-group ml-3">
                  ...
                  <li class="list-group-item active side-tab"><a>Bank Segments</a></li>
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{bankSeg.accountHolderName}}</td>
                        </tr>
                        <tr>
                            <th scope="row">Nomor Rekening</th>
                            <td>{{bankSeg.accountNumber}}</td>
                        </tr>
                    </tbody>
                </table>
...
export default {
  ...
  methods : {
    refreshBorrowerDetails(){
        BorrowerDataService.viewBankSegments(this.uuid).then(res=> {
            this.bankSeg = res.data;
            console.log(this.bankSeg);
        });
    },
  },
  created(){
