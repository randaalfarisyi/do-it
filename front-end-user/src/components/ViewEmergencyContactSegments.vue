...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mt-4 mx-4">
          ...
          <li class="breadcrumb-item active" aria-current="page">Emergency Contact Segments</li>
        </ol>
    </nav>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
              <h3 class="m-4">nama</h3>
                <ul class="list-group ml-3">
                  ...
                  <li class="list-group-item active side-tab"><a> Emergency Contact Segments</a></li>
          ...
          <div class="col-md-9 mt-5">
              <h2 class="m-4">Emergency Contact Segments</h2>
                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            <th scope="row">Hubungan</th>
                            <td>{{emgCSeg.relationship}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{{emgCSeg.gender}}</td>
                        </tr>
                        <tr>
                            <th scope="row">Tipe Kontak</th>
                            <td>{{emgCSeg.contactType}}</td>
                        </tr>
                        <tr>
                            <th scope="row">Nomor Telepon</th>
                            <td>{{emgCSeg.phoneNumber}}</td>
                        </tr>
                    </tbody>
                </table>
...
export default {
  name: "viewEmergencyContactSegments",
  data(){
    return{
        emgCSeg:[],
        errors:[],
  ...
  methods : {
    refreshBorrowerDetails(){
        BorrowerDataService.viewEmergencyContactSegments(this.uuid).then(res=> {
            this.emgCSeg = res.data;
            console.log(this.emgCSeg);
        });
    },
  },
  created(){
