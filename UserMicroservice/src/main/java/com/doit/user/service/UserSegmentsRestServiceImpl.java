...
@Service
@Transactional
public class UserSegmentsRestServiceImpl implements UserSegmentsRestService {
	@Autowired
	private BorrowerDB borrowerDB;
	
	@Override
	public UserSegmentsModel getUserSegmentsByUuidBorrower(String uuidBorrower) {
	...
	@Override
	public UserSegmentsModel changeUserSegments(UserSegmentsModel userSegmentsupdated) {
